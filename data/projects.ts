...
export const PROJECTS: Project[] = [
  {
    ...
    stack: [
      { area: '프레임워크', items: ['Next.js 14 (App Router)', 'React 18'] },
  ...
  },
  {
    ...
    tech: ['Next.js', 'React', 'Canvas', 'LLM', 'Tailwind', 'PWA'],
    stack: [
      { area: '프레임워크', items: ['Next.js 14', 'React 18'] },
      { area: '스타일', items: ['Tailwind CSS 3'] },
      { area: '그리기', items: ['node-canvas 3', 'gif.js'] },
      { area: '부가', items: ['OpenAI', 'crypto-js (SHA-256)', 'Upstash Redis · Ratelimit'] },
    ],
  ...
  },
  {
    ...
    stack: [
      { area: '프레임워크', items: ['Next.js 14 (App Router)', 'React 18'] },
      { area: '스타일', items: ['Tailwind CSS 3'] },
      { area: '부가', items: ['sharp (OG 생성)', 'Vercel Analytics'] },
    ],
  ...
  },
  {
    ...
    stack: [
      { area: '프레임워크', items: ['Next.js 15 (App Router)', 'React 18'] },
  ...
  },
  {
    ...
    tech: ['Next.js', 'React', 'TypeScript', 'Phaser'],
    stack: [
      { area: '엔진', items: ['Phaser 3.90', 'phaser3-rex-plugins'] },
      { area: '셸', items: ['Next.js 15', 'React 19', 'TypeScript'] },
  ...
  },
  {
    ...
    tech: ['React', 'TypeScript', 'Vite', 'Tailwind', 'Supabase', 'LLM'],
    stack: [
  ...
  },
  {
    ...
    stack: [
      { area: '프레임워크', items: ['Next.js 16', 'React 19'] },
      { area: '스타일', items: ['Tailwind CSS 4'] },
